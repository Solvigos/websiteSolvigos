...
const categories = [
  ...
  { name: "CRM & AI Chatbot Setup", icon: IconMessageChatbot },
];
...
const faqs = [
  ...
  { question: "What CRM platforms do you work with?", answer: "We have experience with HubSpot, Salesforce, Zendesk, Freshdesk, Intercom, GoHighLevel (GHL), Gorgias, and Help Scout, among others. If you use a different CRM, let us know — our team evaluates platforms on a case-by-case basis.", category: "CRM & AI Chatbot Setup" },
  { question: "What does CRM setup involve?", answer: "CRM setup includes platform configuration, pipeline and workflow creation, contact data migration, custom field setup, automation building, integration with other tools, and team training. The scope depends on what you need — we can set it up from scratch or optimize an existing instance.", category: "CRM & AI Chatbot Setup" },
  { question: "Can you build and configure chatbots for my website or app?", answer: "Yes. We design, build, and configure chatbots for customer-facing use cases — including FAQ bots, lead capture bots, support deflection bots, and product recommendation flows. We work within your existing platform or recommend the right tool based on your needs.", category: "CRM & AI Chatbot Setup" },
...
export default function FAQPage() {
  ...
  const solutions = [
    ...
    { name: "CRM & AI Chatbot Setup", slug: "crm-chatbot", image: "/moreSolutions/crmChatotSetup.png" },
  ];
  ...
  return (
    <div className="bg-[#F3F4FA] min-h-screen">
      ...
      <section className="bg-[#FFFFFF] py-10 sm:py-20">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
          <h2
