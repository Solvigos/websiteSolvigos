        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-6 pt-4">
            ...
            <div className="animate-fade-in delay-400 flex flex-col sm:flex-row gap-5">
              <a
                href="/contact"
                className="inline-flex items-center justify-center gap-3 rounded-full bg-[#007b7b] hover:bg-[#00f4f4] hover:text-black text-white px-10 py-5 text-lg font-semibold transition-all hover:scale-105 shadow-lg"
              >
